...
class RetryImage extends ImageProvider<Object> {
  ...
  Future<Object> obtainKey(ImageConfiguration configuration) {
    ...
    // If the imageProvider.obtainKey future is synchronous, then we will be
    // able to fill in result with a value before completer is initialized
    // below.
    SynchronousFuture<Object>? result;
    imageProvider.obtainKey(configuration).then((Object key) {
      if (completer == null) {
        // This future has completed synchronously
        // (completer was never assigned),
  ...
  ImageStreamCompleter loadImage(Object key, ImageDecoderCallback decode) {
    ...
    var completerToWrap = imageProvider.loadImage(key, decode);
  ...
  @override
  String toString() => '${objectRuntimeType(this, 'RetryImage')}'
      '(imageProvider: $imageProvider, maxRetries: $maxRetries, scale: $scale)';
}
